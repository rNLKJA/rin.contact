...
const TIERS = [
  {
    ...
    topics: [
      ...
      { label: "Linear Statistical Models", note: "OLS, inference, diagnostics", status: "soon" },
  ...
  },
  {
    ...
    topics: [
      ...
      { href: "/knowledge/statistical-machine-learning", label: "Statistical Machine Learning", note: "Bias-variance, regularisation, generalisation", status: "live" },
