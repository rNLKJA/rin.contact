            ...
            {[
              ...
              <g key={n.t}>
                <rect
                  ...
                  height={32}
                  rx={2}
                  fill={n.t === "guiding Q" ? "#FF3C3C" : "none"}
                  fillOpacity={n.t === "guiding Q" ? 0.12 : 0}
                  stroke={n.t === "guiding Q" ? "#FF3C3C" : "currentColor"}
                  strokeWidth={n.t === "guiding Q" ? 1.4 : 1}
                  opacity={n.t === "guiding Q" ? 1 : 0.7}
                />
                <text
                  x={n.x + 42}
                  y={68}
