...
export default function StatisticalProcessControlKnowledgePage() {
  return (
    <KnowledgeLayout
      slug="statistical-process-control"
      title="Statistical Process Control"
      subtitle="A number moved. Did something real change, or is it just normal wobble? Statistical process control is the discipline of telling those apart over time — so you act on genuine signals and stop chasing noise."
      description="A thorough, practical explainer of statistical process control (SPC) — common-cause vs special-cause variation, control charts and their limits, why three sigma, the Western Electric rules, CUSUM and EWMA for small shifts, and the honest pitfalls. In-Practice tier, anchored to Rin Huang's operational-monitoring work."
    ...
    >
      ...
      <KSection id="chart" eyebrow="03" title="The control chart">
        ...
        <Figure caption="A control chart. Points wobbling within the limits are common-cause variation — the process is in control, leave it alone. A point breaching a control limit is a special-cause signal — investigate. The limits encode 'how much wobble is normal' for this process.">
          <svg
            viewBox="0 0 440 160"
            className="w-full max-w-[460px] h-auto mx-auto text-[#3D3D3D] dark:text-[#CFCFCF]"
            role="img"
            aria-label="A time series of points within an upper and lower control limit, with the centre line in the middle and one point breaching the upper limit highlighted."
          >
            {/* limit lines */}
            <line
              x1="30"
            ...
            {[
              ...
              return (
                <g key={i}>
                  {i > 0 && (
                    <line
                      x1={[45, 75, 105, 135, 165, 195, 225, 255, 285, 315, 345, 375][i - 1]}
                      y1={[72, 90, 65, 95, 78, 60, 88, 70, 18, 84, 66, 92][i - 1]}
                      x2={x}
                      y2={y}
                      stroke="currentColor"
                      strokeWidth="0.8"
