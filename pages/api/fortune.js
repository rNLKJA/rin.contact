const FORTUNES = [
  ...
  {
    text: "It is a capital mistake to theorise before one has data.",
  ...
  {
    text: "The data may not contain the answer. The combination of some data and an aching desire for an answer does not ensure that a reasonable answer can be extracted from a given body of data.",
    author: "John Tukey",
  },
  ...
  // Rin originals
  {
    text: "Strategic thinking is knowing which questions to ask before you know the answers.",
    author: "Rin Huang",
  },
