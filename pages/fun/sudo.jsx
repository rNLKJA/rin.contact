      ...
      <div className="min-h-screen bg-[#0C0C0C] flex items-center justify-center px-6 font-mono">
        <div className="max-w-lg w-full">
          <div className="text-xs text-[#555] leading-loose mb-6">
            <p>
              <span className="text-[#FF3C3C]">rin@portfolio</span>
              <span className="text-[#444]">:</span>
              <span className="text-[#3A7BD5]">~</span>
              <span className="text-[#444]">$</span> sudo su
            </p>
            ...
            <p className="mt-1 text-[#333]">
              [sudo] password for guest: <span className="animate-blink text-[#FF3C3C]">_</span>
            </p>
          </div>
          ...
          <div className="border border-[#1E1E1E] p-5 text-xs text-[#555] leading-relaxed mb-8">
            ...
            <p className="mt-2 text-[#333]">
              Access to Rin&apos;s root is restricted to:
              <br />
              <span className="text-[#666] ml-2">• SAPOL (production)</span>
              <br />
              <span className="text-[#666] ml-2">• Mapiva core team (staging)</span>
              <br />
