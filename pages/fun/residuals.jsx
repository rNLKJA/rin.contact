  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="What's left after you subtract expectations from reality." />
      ...
      <SeoHead
        ...
        path="/fun/residuals"
        ogImage={{ title: "Residuals", subtitle: "What's left after you subtract expectations from reality.", section: "fun" }}
        noindex={true}
      />

      <div className="min-h-screen bg-white flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          <p className="text-[10px] tracking-widest uppercase text-[#FF3C3C] font-mono mb-4">/fun/residuals</p>
          ...
          <p className="text-sm text-[#7A7A7A] leading-relaxed mb-8">
            In regression: observed − predicted. In life: what you didn&apos;t plan for.
            Sometimes the residuals are the interesting part.
          </p>
