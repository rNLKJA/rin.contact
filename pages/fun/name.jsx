    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-8">黄孙创宇</h1>
          ...
          <p className="text-sm text-[#1A1A1A] leading-relaxed mb-8">
            Three ways to refer to the same person. Chinese name (family name first), romanised, and
            the nickname that stuck. Use whichever feels right.
          </p>
