  ...
  return (
    <>
      ...
      <SeoHead
        ...
        ogImage={{
          title: "Timezone",
          subtitle: "Adelaide UTC+9:30. We're not on a full hour.",
          section: "fun",
        }}
        noindex={true}
      />
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <p className="text-sm text-[#1A1A1A] leading-relaxed mb-8">
            ACST. Half an hour ahead of Perth, half behind Brisbane. The only Australian state that
            refuses to round. I like it that way.
          </p>
