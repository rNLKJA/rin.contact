    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          <p className="text-[10px] tracking-widest uppercase text-[#FF3C3C] font-mono mb-4">/fun/normalise</p>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">Normalise</h1>
          <p className="text-sm text-[#7A7A7A] mb-8">
            Normalising your expectations.
          </p>
          <p className="text-sm text-[#1A1A1A] leading-relaxed mb-8">
            Stop comparing yourself to the mean. Your distribution is different.
            Everyone&apos;s journey is a different scale. Z-score yourself against your own past, not someone else&apos;s present.
          </p>
