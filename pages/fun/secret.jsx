    ...
    <>
      ...
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        <div className="max-w-lg w-full font-mono">
          ...
          <h1 className="text-2xl font-semibold tracking-tight mb-2">The secret is out.</h1>
          <p className="text-[#686868] text-xs mb-10 leading-relaxed">
            Hidden in the dots at the bottom of the homepage is a message. It&apos;s been there the
            whole time. Can you decode it?
          </p>
          ...
          {decoded && (
            <div className="border border-[#1E1E1E] p-5 mb-6 text-center">
              ...
              <p className="text-xs text-[#686868] leading-relaxed">
                Simple. Direct. Intentional. That is how I approach everything — data science,
                design, and apparently also hidden messages.
              </p>
            </div>
          )}
          ...
          <div className="border-t border-[#1E1E1E] pt-6 mb-8">
            ...
            <p className="text-xs text-[#686868] leading-relaxed">
              Look at the very bottom of the homepage. A subtle row of dots and dashes sits in the
              footer decoration — barely visible, but there if you look for it. Dots are circles.
              Dashes are rectangles. Five characters. One word.
            </p>
          </div>
          ...
          <div className="border border-[#1E1E1E] p-5 mb-8">
            ...
            <ul className="text-xs text-[#686868] space-y-2">
              <li>
                → <span className="text-[#888]">↑↑↓↓←→←→BA</span> — try it on the homepage
              </li>
              <li>
                → <code className="text-[#888]">curl rin.contact</code> — a different view entirely
              </li>
              <li>
                → <code className="text-[#888]">curl rin.contact/api/ping</code> — pong
              </li>
              <li>
                → <span className="text-[#888]">/fun/coffee</span> — you know why
              </li>
              <li>
                → <span className="text-[#888]">/hire-me</span> — in case that is why you are here
              </li>
            </ul>
          </div>
