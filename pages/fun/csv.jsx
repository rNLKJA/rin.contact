    ...
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          <p className="text-[10px] tracking-widest uppercase text-[#FF3C3C] font-mono mb-4">/fun/csv</p>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">Data-And-More(9_001).csv</h1>
          ...
          <div className="border border-[#E0E0E0] p-4 mb-6 overflow-x-auto">
            <pre className="font-mono text-[11px] text-[#3D3D3D] whitespace-pre">
              {csv}
            </pre>
          </div>
