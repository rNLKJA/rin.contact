    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <p className="text-sm text-[#7A7A7A] mb-8">Every no is training data.</p>
          <p className="text-sm text-[#1A1A1A] leading-relaxed mb-8">
            I&apos;ve been rejected. Applications, papers, ideas. It happens. The useful part: each
            rejection is a data point. Wrong fit, wrong time, or wrong approach. Learn, adjust, try
            again.
          </p>
