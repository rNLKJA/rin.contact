...
const CONFOUNDERS = [
  "summer", "caffeine", "deadlines", "confirmation bias",
  "time", "selection", "survivorship", "Friday 5pm",
];
    ...
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">Spurious Correlations</h1>
          ...
          <div className="space-y-4">
            {shown.map((i) => {
              ...
              return (
                <div key={`${a}-${b}`} className="border border-[#E0E0E0] p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
