...
const IntroductionToDatabase = () => {
  const [agenda, setAgenda] = useState([]);

  useEffect(() => {
    fetch("/data/data-science/databaseAndDataAnalysisAgenda.json")
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1>Introduction to Database & SQL Challenges</h1>
...
export default IntroductionToDatabase;
