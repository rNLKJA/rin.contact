...
const IMAGES = [
  {
    ...
    caption: "Senior Data Analyst & Research Software Engineer, Adelaide, Australia",
    license: BASE_URL,
  },
  {
  ...
  },
  {
    ...
    title: "CBS — Attorney-General's Department SA",
    caption: "ASO4 Intelligence & Coordination Officer, Jan 2025–Mar 2026",
...
const KNOWLEDGE = [
  ...
  { path: "/knowledge/sampling-survey-methodology", priority: 0.6, freq: "monthly" },
  { path: "/knowledge/sql-querying-data", priority: 0.6, freq: "monthly" },
  { path: "/knowledge/reinforcement-learning", priority: 0.6, freq: "monthly" },
