        ...
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <div className="border border-[#E0E0E0] dark:border-[#3D3D3D] p-6 font-mono text-xs space-y-6">
            <div>
              ...
              <p className="text-[#1A1A1A] dark:text-white">Python (right-skewed), SQL (normal), Rust (bimodal, early stage)</p>
            </div>
            <div>
              <p className="text-[10px] text-[#FF3C3C] mb-2">HISTOGRAM: Career timeline</p>
              <p className="text-[#1A1A1A] dark:text-white">Peaks at 6–18 month tenure. No outliers (yet).</p>
            </div>
            <div>
              <p className="text-[10px] text-[#FF3C3C] mb-2">CORRELATION: Skills × Projects</p>
              <p className="text-[#1A1A1A] dark:text-white">Python–Data Eng: 0.92. React–Mobile: 0.78. Government–Power BI: 0.85.</p>
            </div>
          </div>
