    ...
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          <p className="text-[10px] tracking-widest uppercase text-[#FF3C3C] font-mono mb-4">/ds/eda</p>
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">Exploratory Data Analysis</h1>
          <p className="text-sm text-[#7A7A7A] mb-10">
            Rin as a dataset. Distributions, histograms, correlations.
          </p>

          <div className="border border-[#E0E0E0] p-6 font-mono text-xs space-y-6">
            <div>
              <p className="text-[10px] text-[#FF3C3C] mb-2">DISTRIBUTION: Skills</p>
              <p className="text-[#1A1A1A]">Python (right-skewed), SQL (normal), Rust (bimodal, early stage)</p>
            </div>
            <div>
              <p className="text-[10px] text-[#FF3C3C] mb-2">HISTOGRAM: Career timeline</p>
              <p className="text-[#1A1A1A]">Peaks at 6–18 month tenure. No outliers (yet).</p>
            </div>
            <div>
              <p className="text-[10px] text-[#FF3C3C] mb-2">CORRELATION: Skills × Projects</p>
              <p className="text-[#1A1A1A]">Python–Data Eng: 0.92. React–Mobile: 0.78. Government–Power BI: 0.85.</p>
            </div>
          </div>
