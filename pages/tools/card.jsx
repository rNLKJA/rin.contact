          ...
          >
            ...
            >
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <div
                      className="w-10 h-10 bg-[#FF3C3C] flex items-center justify-center text-white text-base font-semibold mb-4"
                      style={{ borderRadius: "22%" }}
                      aria-hidden="true"
                    >
                      R
                    </div>
                    <p className="text-lg font-semibold tracking-tight leading-tight text-white">
                      Sunchuangyu Huang
                    </p>
                    <p className="text-xs text-[#9A9A9A] tracking-wider mt-0.5">Rin · 黄孙创宇</p>
                  </div>
                  <p className="text-[9px] font-mono tracking-[0.25em] uppercase text-[#7A7A7A]">
                    /card
                  </p>
                </div>
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      <p className="text-[10px] font-semibold tracking-wide text-white">
                        ASO7 Senior Data Analyst
                      </p>
                      <p className="text-[10px] text-[#9A9A9A] tracking-wide">
                        South Australia Police
                      </p>
                      <p className="text-[10px] text-[#7A7A7A] mt-1.5 tracking-wide">
                        huang@rin.contact · rin.contact
                      </p>
                    </div>
                    <div
                      className="w-2.5 h-2.5 bg-[#FF3C3C]"
            ...
            >
              ...
              <div className="relative h-full flex items-center gap-5 p-6" style={{ zIndex: 1 }}>
                ...
                <div>
                  <p className="text-[10px] font-mono tracking-[0.25em] uppercase text-[#FF3C3C] mb-2">
                    {t("cardPage.scanToConnect")}
                  </p>
                  <p className="text-sm font-semibold text-white leading-snug">
                    {t("cardPage.pointCamera")}
                  </p>
  ...
  return (
    <>
      ...
      <h1 className="sr-only">
        {t("cardPage.ogTitle")} — {t("common.siteName")}
      </h1>
        ...
        <div className="mt-16 w-full space-y-3" style={{ maxWidth: "min(380px, 90vw)" }}>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="flex-1 border border-[#E0E0E0] dark:border-[#3D3D3D] text-[#3D3D3D] dark:text-[#AAAAAA] px-4 py-2.5 text-xs tracking-widest uppercase hover:border-black hover:text-black dark:hover:border-white dark:hover:text-white transition-colors duration-200 font-mono text-center"
            >
              {t("cardPage.email")}
            </a>
            <a
          ...
          <Link
            href="/"
            className="block border border-[#E0E0E0] dark:border-[#3D3D3D] text-[#7A7A7A] dark:text-[#9A9A9A] px-6 py-2.5 text-xs tracking-widest uppercase hover:border-black hover:text-black dark:hover:border-white dark:hover:text-white transition-colors duration-200 font-mono text-center"
          >
