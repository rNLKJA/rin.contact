  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://rin.contact/api/og/?title=References&subtitle=People%20who%20can%20speak%20to%20Rin%20Huang%20work%20and%20character&section=info"
        />
        ...
        <meta
          ...
          content="People who can speak to Rin Huang work and character."
        />
        <meta
          name="twitter:image"
          content="https://rin.contact/api/og/?title=References&subtitle=People%20who%20can%20speak%20to%20Rin%20Huang%20work%20and%20character&section=info"
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">
            {t("infoReferences.heading")}
          </h1>
          <p className="text-sm text-[#7A7A7A] mb-10">{t("infoReferences.intro")}</p>
