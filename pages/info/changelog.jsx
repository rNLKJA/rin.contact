        ...
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <div className="space-y-6">
            {RELEASES.map(({ version, date }, i) => (
              <div
                key={version}
                className="border-b border-[#F0F0F0] dark:border-[#1E1E1E] pb-6 last:border-0"
              >
                <p className="font-mono text-sm text-[#1A1A1A] dark:text-white mb-1">
                  v{version} · {date}
                </p>
