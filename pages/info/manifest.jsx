  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://rin.contact/api/og/?title=Manifest&subtitle=The%20principles%2C%20values%2C%20and%20philosophy%20behind%20rin&section=info"
        />
        ...
        <meta
          ...
          content="The principles, values, and philosophy behind rin."
        />
        <meta
          name="twitter:image"
          content="https://rin.contact/api/og/?title=Manifest&subtitle=The%20principles%2C%20values%2C%20and%20philosophy%20behind%20rin&section=info"
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <h1 className="text-3xl md:text-4xl font-semibold tracking-tight mb-3">
            {t("infoManifest.heading")}
          </h1>
          <p className="text-sm text-[#7A7A7A] mb-14">{t("infoManifest.intro")}</p>

          <div className="space-y-6">
            {t("infoManifest.principles").map((p, i) => (
              <p
                key={i}
                className="text-sm text-[#1A1A1A] dark:text-white leading-relaxed border-l-2 border-[#E0E0E0] dark:border-[#3D3D3D] pl-4"
              >
                {p}
              </p>
            ))}
