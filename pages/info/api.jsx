  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://rin.contact/api/og/?title=API&subtitle=Public%20API%20endpoints%20for%20rin&section=info"
        />
      ...
      <div className="min-h-screen bg-white dark:bg-[#0A0A0A] flex flex-col">
        <div className="max-w-[680px] mx-auto px-6 md:px-12 py-20 md:py-28 flex-1">
          ...
          <p className="text-sm text-[#7A7A7A] mb-14">{t("infoApi.intro")}</p>
          ...
          <div className="space-y-8">
            {ENDPOINTS.map(({ path, method, example }, i) => (
              ...
              >
                ...
                <p className="text-sm text-[#3D3D3D] dark:text-[#6E6E6E] dark:text-[#9A9A9A] mb-4">
                  {descriptions[i]}
                </p>
