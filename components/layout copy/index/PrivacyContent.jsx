  ...
  return (
    <div className="p-8">
      ...
      <p>
        ...
        committed to protecting it through my compliance with this policy. This
        policy describes:
      </p>
      ...
      <ul className="list-disc ml-4">
        ...
        <li>
          When you interact with my advertising and applications on third-party
      ...
      <ul className="list-disc ml-4">
        <li>
          Me offline or through any other means, including on any other website
