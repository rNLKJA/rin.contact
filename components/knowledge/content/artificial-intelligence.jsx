  ...
  return (
    <Figure caption={caption}>
      ...
      >
        ...
        <text x="60" y="94" textAnchor="middle" fontSize="10" fontFamily="monospace" fill="currentColor">{startLabel}</text>
        ...
        <text x="410" y="72" textAnchor="middle" fontSize="10" fontFamily="monospace" fill="currentColor">{goalLabel}</text>
      </svg>
    </Figure>
  );
}

function AgentLoopFigure({ caption, ariaLabel, agentLabel, agentSub, environmentLabel, actionLabel, perceptLabel }) {
  return (
    <Figure caption={caption}>
      <svg
        viewBox="0 0 440 150"
      ...
      >
        ...
        <text x="100" y="74" textAnchor="middle" fontSize="11" fontFamily="monospace" fill="currentColor">{agentLabel}</text>
        <text x="100" y="88" textAnchor="middle" fontSize="8" fontFamily="monospace" fill="currentColor" opacity="0.7">{agentSub}</text>
        <rect x="280" y="55" width="120" height="44" rx="2" fill="none" stroke="currentColor" strokeWidth="1.2" />
        <text x="340" y="80" textAnchor="middle" fontSize="11" fontFamily="monospace" fill="currentColor">{environmentLabel}</text>
        <line x1="160" y1="66" x2="278" y2="66" stroke="#FF3C3C" strokeWidth="1.4" markerEnd="url(#ai-ah)" />
        <text x="219" y="58" textAnchor="middle" fontSize="9" fontFamily="monospace" fill="currentColor">{actionLabel}</text>
        <line x1="278" y1="88" x2="160" y2="88" stroke="currentColor" strokeWidth="1.2" markerEnd="url(#ai-ah2)" />
        <text x="219" y="104" textAnchor="middle" fontSize="9" fontFamily="monospace" fill="currentColor" opacity="0.75">{perceptLabel}</text>
        <defs>
  ...
  return (
    <>
      ...
      <KSection id="search" eyebrow="02" title="作为搜索的问题求解">
        ...
        <ul>
          <li><Term>状态</Term>——可能的配置（一个棋盘局面、你所在的一座城市）。</li>
          <li><Term>初始状态</Term>——你的起点。</li>
          <li><Term>动作</Term>——从某状态出发的合法移动。</li>
          <li><Term>目标检验</Term>——你如何认出自己已经到达。</li>
          <li><Term>路径代价</Term>——每一步的花费，让你能偏好更便宜的解。</li>
        </ul>
        <p>
          搜索会构建一棵树：根是起点，分支是动作，你向外扩展节点以寻找目标。全部的艺术在于你
          扩展的<em>顺序</em>——因为这棵树通常大到无法完全探索。
        </p>
      </KSection>
      ...
      <KSection id="astar" eyebrow="04" title="有信息搜索与 A*">
        ...
        <p>
          A* 是可证明最优的——保证找到最便宜的路径——只要启发函数是<Term>可采纳的</Term>，
          即它从不<em>高估</em>真实的剩余代价：
        </p>
      ...
      <KSection id="csp" eyebrow="06" title="约束满足">
        ...
        <p>
          你用聪明的<Term>回溯</Term>来解它们——赋一个变量、检查约束，一碰到死路就立刻退回——
          并由<Term>约束传播</Term>加速，它在你尝试之前就把其他变量论域里不可能的取值剪掉。
          CSP 是一把优雅而通用的锤子：数量惊人的真实规划与分配问题，只是披着外衣的 CSP。
        </p>
      </KSection>
