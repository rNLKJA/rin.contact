      ...
      >
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="tel:+61450270703" className="text-sm link-hover">
                +61 450 270 703
              </a>
            </div>
            <div className="flex items-center gap-3">
              <FiMapPin size={16} className="text-[#7A7A7A]" aria-hidden="true" />
              <span className="text-sm text-[#3D3D3D]">Adelaide &amp; Melbourne, Australia</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {SOCIALS.map(({ label, href, icon: Icon, handle }) => (
              ...
              >
                <Icon
                  size={16}
                  className="text-[#7A7A7A] group-hover:text-black transition-colors duration-200"
                  aria-hidden="true"
                />
                <span className="text-sm text-[#3D3D3D] group-hover:text-black transition-colors duration-200">
                  {handle}
                </span>
              </a>
            ))}
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="border border-black px-6 py-3 text-sm tracking-widest uppercase
                       hover:bg-black hover:text-white transition-colors duration-200 text-center w-fit"
        ...
        >
          <div className="flex flex-col gap-1.5">
            <label
              htmlFor="name"
              className="text-xs tracking-widest uppercase text-[#7A7A7A]"
            >
              Name
            </label>
            <input
              ...
              className="border border-[#E0E0E0] px-4 py-3 text-sm bg-white
                         placeholder:text-[#7A7A7A] focus:outline-none focus:border-black
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="border border-[#E0E0E0] px-4 py-3 text-sm bg-white resize-none
                         placeholder:text-[#7A7A7A] focus:outline-none focus:border-black
                         transition-colors duration-200 rounded-none"
            />
          </div>
          ...
          {status === "error" && (
            <p className="text-xs text-[#FF3C3C]" role="alert">
              Something went wrong. Please try emailing me directly at huang@rin.contact.
            </p>
          )}
        </form>
      </div>
